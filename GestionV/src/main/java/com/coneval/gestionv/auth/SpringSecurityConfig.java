...
public class SpringSecurityConfig {
    ...
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http.authorizeHttpRequests(auth -> auth.requestMatchers(HttpMethod.GET,"/api/v1/listar").permitAll()
                        ...
                        .requestMatchers(HttpMethod.POST,"/api/v1/crear").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT,"/api/v1/editar/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT,"/api/v1/vacaciones/editar/**").hasAnyRole("ADMIN","USER")
                        .requestMatchers(HttpMethod.DELETE,"/api/v1/eliminar/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.DELETE,"/api/v1/vacaciones/eliminar/**").hasAnyRole("ADMIN","USER")
                        .requestMatchers(HttpMethod.GET,"/api/v1/vacaciones/**").permitAll()
                        .requestMatchers(HttpMethod.GET,"/api/v1/listarPage/**").permitAll()
                        .requestMatchers(HttpMethod.GET,"/api/v1/vacaciones/all/**").permitAll()
                        .requestMatchers(HttpMethod.GET,"/api/v1/vacaciones/byemail/**").hasAnyRole("ADMIN","USER")
                        .requestMatchers(HttpMethod.GET,"/report/vacaciones/download/**").hasAnyRole("ADMIN","USER")
                        .requestMatchers(HttpMethod.POST,"/api/v1/vacaciones/crear/**").hasAnyRole("ADMIN","USER")
